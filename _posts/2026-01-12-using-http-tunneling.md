...
1. In Windows Explorer, and type the following in the address line: ***ftp://web\_server\_name|ip address:port/***. This will move you to the folders on the web server.
